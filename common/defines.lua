...
NCountry = {
	...
	ESTATE_PRIVILEGES_MAX_CONCURRENT = 9,		-- Max. number of privileges active at the same time. Also see ESTATE_MAX_PRIVILEGES in NAI
...
NAI = {
	...
	ESTATE_MAX_PRIVILEGES = 9, -- Also see ESTATE_PRIVILEGES_MAX_CONCURRENT in NCountry
